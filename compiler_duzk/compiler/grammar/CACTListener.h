...
public:
  ...
  virtual void enterVarDefVal(CACTParser::VarDefValContext *ctx) = 0;
  virtual void exitVarDefVal(CACTParser::VarDefValContext *ctx) = 0;
  ...
  virtual void enterVarDefInitVal(CACTParser::VarDefInitValContext *ctx) = 0;
  virtual void exitVarDefInitVal(CACTParser::VarDefInitValContext *ctx) = 0;

  virtual void enterVarDefInitArray(CACTParser::VarDefInitArrayContext *ctx) = 0;
  virtual void exitVarDefInitArray(CACTParser::VarDefInitArrayContext *ctx) = 0;
  ...
  virtual void enterBlockltem(CACTParser::BlockltemContext *ctx) = 0;
  virtual void exitBlockltem(CACTParser::BlockltemContext *ctx) = 0;
  ...
  virtual void enterFuncCall(CACTParser::FuncCallContext *ctx) = 0;
  virtual void exitFuncCall(CACTParser::FuncCallContext *ctx) = 0;
